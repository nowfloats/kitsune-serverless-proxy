...
                    let storageKeysToDelete = await cloudHelper.storageListAllFiles(path, process.env.STORAGE_BUCKET_NAME);
                    if(debugMode){
                        console.log("storageKeysToDelete: " + JSON.stringify(storageKeysToDelete));
                    }
                    try{
                        await cloudHelper.storageDelete(storageKeysToDelete, process.env.STORAGE_BUCKET_NAME);
                        if(!responseStorage){
                            responseStorage =  {
                                status : "success"
                            }
...
                let responseStorage = null;
                try{
                    await cloudHelper.storageDelete(requestObject.PathsToInvalidate, process.env.STORAGE_BUCKET_NAME);
                    responseStorage =  {
                        status : "success"
                    }
                }catch(ex){
